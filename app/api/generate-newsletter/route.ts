...
export async function POST(request: NextRequest) {
  try {
    ...
    if (location) {
      ...
      result = await newsletterGenerator.generateLocationBasedNewsletterWithDB(
        location,
        categories,
        weekOf
      )
      ...
      result = await newsletterGenerator.generatePersonalizedNewsletterWithDB(
        categories,
        userPreferences,
        weekOf
      )
      ...
      result = await newsletterGenerator.generateNewsletterContentWithDB(
        categories,
        weekOf
      )
    }
