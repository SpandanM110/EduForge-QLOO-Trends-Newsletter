...
This approach to content creation isn't just about automation—it's about augmentation. The technology enhances human creativity and insight, allowing for more personalized and relevant content delivery at scale. As these systems continue to evolve, we can expect even more sophisticated and nuanced content generation capabilities.`,
            ...
            trending: true,
            source_data: {
              entity_id: "ai-content",
              name: "AI Content",
              type: "technology",
            },
            read_time: "3 min read",
            excerpt:
              "Exploring how AI and real-time data are revolutionizing content creation and personalization.",
...
Looking ahead, emerging technologies like virtual reality, augmented reality, and interactive storytelling promise to further revolutionize the entertainment landscape. These innovations will create more immersive and personalized entertainment experiences than ever before.`,
            ...
            trending: true,
            source_data: {
              entity_id: "digital-entertainment",
              name: "Digital Entertainment",
              type: "entertainment",
            },
            read_time: "4 min read",
            excerpt:
              "How streaming, social media, and emerging technologies are reshaping the entertainment industry.",
...
The intersection of technology and culture continues to evolve, with emerging platforms and tools constantly reshaping how we interact and express ourselves. Understanding these digital cultural currents has become essential for anyone seeking to navigate our interconnected world.`,
            ...
            trending: false,
            source_data: {
              entity_id: "digital-culture",
              name: "Digital Culture",
              type: "culture",
            },
            read_time: "3 min read",
            excerpt:
              "Examining how digital platforms are reshaping cultural expression and community building.",
            tags: [
              "culture",
              "social-media",
              "creator-economy",
    ...
    // Use the database-integrated method for consistent behavior
    const result = await newsletterGenerator.generateNewsletterContentWithDB(
      previewCategories
    );
    const articles = result.articles;

    console.log(`✅ Generated ${articles.length} preview articles`);
    console.log(`💾 Newsletter saved to DB with ID: ${result.newsletter.id}`);

    // Ensure we have at least some content for preview
        ...
        articles: [
          {
            ...
            excerpt:
              "Live content is being generated from current trends and entertainment data.",
    ...
    return NextResponse.json({
      success: true,
      articles: articles.slice(0, 3), // Limit to 3 for preview
      newsletter: {
      ...
      articles: [
        {
          ...
          excerpt:
            "Fresh content is being generated from live trend data and entertainment insights.",
